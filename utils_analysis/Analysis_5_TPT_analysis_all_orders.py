...
os.chdir("..")
path = os.getcwd() + '/result/last_runs/last_runs_04-12-2023_10-11-40.json'
...
for i in range(len(data["orders"][0]["orders"])):
    ...
    if completion_time != 0:
        ...
        with open('tpt_all_orders' + '.csv', 'a+', newline='', encoding='utf-8') as file:
            writer = csv.writer(file)
            writer.writerow([i, round(throughput_time,1), round(tardiness,1)])