...
normal_state = {"order": ["type", "tasks_finished", "next_task", "locked", "picked_up", "in_same_cell", "in_m_input", "in_m", "processing", "due_to","remaining_tasks", "priority", "time_in_cell"],
                "buffer": ["free_slots"],
                "machine": ["failure"],
                "agent": []}

smart_state = {"order": ["type", "tasks_finished", "next_task", "locked", "picked_up", "in_same_cell", "in_m_input", "in_m", "processing", "time_in_cell", "due_to", "priority"],
...
smart_state_full = {"order": ["start", "due_to", "complexity", "type",
                        "time_in_cell", "locked", "picked_up", "processing", "tasks_finished", "remaining_tasks",
                        "next_task", "distance", "in_m", "in_m_input", "in_same_cell", "priority"],
